...
const Tableware = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:8000/Tableware')
  ...
  return (
    <div className="container mx-auto px-4">
      <h1 className="text-3xl font-bold text-center my-8 text-purple-600">Explore the Extensive range of Tableware from FolkArtify Online</h1>
