...
const Walldecor= () => {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:8000/WallDecor')
      .then((response) => response.json())
      .then((data) => setWalldecor(data))
      .catch((error) => console.error('Error fetching data:', error));
  }, []);

  return (
    <div className="container mx-auto px-4">
      <h1 className="text-3xl font-bold text-center my-8 text-purple-600">Shop Wall Decor from FolkArtify Online</h1>
